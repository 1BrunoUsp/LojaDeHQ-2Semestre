    ...
    <section>
        ...
        <div class="form-box">
            <div class="form-value">
                <form action="Tela.act/Cadastro.act.php" method="post" enctype="multipart/form-data">
                    <h2>Register</h2>
                    <div class="inputbox">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="adm" id="adm" value="1">
                    ...
                    <div class="register">
                        <p>Possui Uma Conta? <a href="TelaDeLogin.php">Login</a></p>
                    </div>
                </form>
            </div>
        </div>
